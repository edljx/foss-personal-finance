<div align="center">
  ...
  <h1>FOSS Personal Finance</h1>
  <p>A curated list of free and open source personal finance, budgeting, and accounting software.</p>
</div>
...
A curated catalog of free and open source software for budgeting, expense tracking, portfolio management, double-entry accounting, and plain-text ledgers.
...
* **[firefly-iii](https://github.com/firefly-iii/firefly-iii)** — self-hosted manager for budgets, bills, accounts, and transactions.
* **[sure](https://github.com/we-promise/sure)** — personal finance app for tracking income, expenses, and goals.
* **[wealthfolio](https://github.com/wealthfolio/wealthfolio)** — desktop portfolio and net-worth tracker.
* **[Wallos](https://github.com/ellite/Wallos)** — self-hosted subscription tracker and budget helper.
* **[mintable](https://github.com/kevinschaich/mintable)** — minimalist personal finance tracker with bank CSV import.
* **[budget-board](https://github.com/teelur/budget-board)** — self-hosted dashboard for household budgets and spending categories.
* **[ocular](https://github.com/simonwep/ocular)** — personal expense visualizer that turns CSV statements into charts.
* **[financial-freedom](https://github.com/serversideup/financial-freedom)** — self-hosted debt-payoff and net-worth tracker with projection charts.
* **[money-tracker](https://github.com/ayastreb/money-tracker)** — simple mobile-first money in/out tracker.
...
* **[ExpenseOwl](https://github.com/Tanq16/ExpenseOwl)** — lightweight self-hosted expense and income tracker.
